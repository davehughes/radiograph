...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('radioapp_image', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Specimen.deleted'
        db.add_column('radioapp_specimen', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.deleted'
        db.delete_column('radioapp_image', 'deleted')

        # Deleting field 'Specimen.deleted'
        db.delete_column('radioapp_specimen', 'deleted')
