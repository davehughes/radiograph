...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('radiograph_specimen', 'skull_length', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Specimen.cranial_width'
        db.add_column('radiograph_specimen', 'cranial_width', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Specimen.neurocranial_height'
        db.add_column('radiograph_specimen', 'neurocranial_height', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Specimen.facial_height'
        db.add_column('radiograph_specimen', 'facial_height', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Specimen.palate_length'
        db.add_column('radiograph_specimen', 'palate_length', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Specimen.palate_width'
        db.add_column('radiograph_specimen', 'palate_width', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Specimen.created_by'
        db.add_column('radiograph_specimen', 'created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='specimens_created', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'Specimen.last_modified_by'
        db.add_column('radiograph_specimen', 'last_modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='specimens_last_modified', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Specimen.skull_length'
        db.delete_column('radiograph_specimen', 'skull_length')

        # Deleting field 'Specimen.cranial_width'
        db.delete_column('radiograph_specimen', 'cranial_width')

        # Deleting field 'Specimen.neurocranial_height'
        db.delete_column('radiograph_specimen', 'neurocranial_height')

        # Deleting field 'Specimen.facial_height'
        db.delete_column('radiograph_specimen', 'facial_height')

        # Deleting field 'Specimen.palate_length'
        db.delete_column('radiograph_specimen', 'palate_length')

        # Deleting field 'Specimen.palate_width'
        db.delete_column('radiograph_specimen', 'palate_width')

        # Deleting field 'Specimen.created_by'
        db.delete_column('radiograph_specimen', 'created_by_id')

        # Deleting field 'Specimen.last_modified_by'
        db.delete_column('radiograph_specimen', 'last_modified_by_id')
