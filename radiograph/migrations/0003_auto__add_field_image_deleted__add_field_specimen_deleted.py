...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.deleted'
        db.add_column('radiograph_image', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Specimen.deleted'
        db.add_column('radiograph_specimen', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.deleted'
        db.delete_column('radiograph_image', 'deleted')

        # Deleting field 'Specimen.deleted'
        db.delete_column('radiograph_specimen', 'deleted')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 28, 13, 42, 3, 224139)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 28, 13, 42, 3, 224048)'}),
