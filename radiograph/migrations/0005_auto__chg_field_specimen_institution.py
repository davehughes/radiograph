...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Specimen.institution'
        db.alter_column(u'radiograph_specimen', 'institution_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['radiograph.Institution']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Specimen.institution'
        raise RuntimeError("Cannot reverse this migration. 'Specimen.institution' and its values cannot be restored.")
