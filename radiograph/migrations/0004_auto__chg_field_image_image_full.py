...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'radiograph_image', 'original_path',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'Image.md5'
        db.add_column(u'radiograph_image', 'md5',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True),
                      keep_default=False)


        # Changing field 'Image.image_full'
        db.alter_column(u'radiograph_image', 'image_full', self.gf('django.db.models.fields.files.FileField')(max_length=1024))

    def backwards(self, orm):
        # Deleting field 'Image.original_path'
        db.delete_column(u'radiograph_image', 'original_path')

        # Deleting field 'Image.md5'
        db.delete_column(u'radiograph_image', 'md5')


        # Changing field 'Image.image_full'
        db.alter_column(u'radiograph_image', 'image_full', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        u'radiograph.image': {
            ...
            'specimen': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'to': u"orm['radiograph.Specimen']"})
        },
        ...
        u'radiograph.specimen': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'institution': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'specimens'", 'to': u"orm['radiograph.Institution']"}),
