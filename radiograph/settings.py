...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(SITE_ROOT_DIR, 'app.db'),                      # Or path to database file if using sqlite3.
...
HAYSTACK_SOLR_URL = 'http://localhost:8080/solr/radiograph'
