  ...
  this.include = function() {
    ...
    this.view({
      'specimen-detail': function() {
        return div('.specimen-detail', function() {
          h3(function() {
            span('.taxon', function() {
    ...
    this.view({
      'specimen-table': function() {
        ...
        span('.sex.dropdown', function() {
          ...
          return div('.dropdown-menu', function() {
            var label_, value, _i, _len, _ref, _ref1;
            _ref = this.sexChoices;
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              _ref1 = _ref[_i], value = _ref1[0], label_ = _ref1[1];
            ...
            return a('.btn.btn-primary', function() {
              return 'Filter';
            });
          });
        });
          ...
          div('.institution.control-group', function() {
            ...
            return div('.controls', function() {
              return select({
                ...
                var label, value, _i, _len, _ref, _ref1, _results;
                option(function() {
                  return '---------';
                });
